...
\rett{Mute Audio to Radio}. If checked, the audio from this receiver is muted, no matter whether
it is active or not.
...
editor. In principle, you could change the \texttt{Makefile} directly, but as soon as you  modify
...
PulseAudio is used. On MacOS, the \texttt{AUDIO} choice has no effect since only the
PortAudio module works well.
